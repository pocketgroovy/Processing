...
=======
>>>>>>> e8aeabb16d540e9f5a9ba76f5fcc94488899384b
//  if (mousePressed){
//     dragging = true;
//      droid.setPosition(physics.screenToWorld(new Vec2(mouseX, mouseY)));
//  }
<<<<<<< HEAD
=======
>>>>>>> b8d12f9e6be90e665f1432137c4f8a0d8b79644b
>>>>>>> e8aeabb16d540e9f5a9ba76f5fcc94488899384b
}
...
void collision(Body b1, Body b2, float impulse)
{
  ...
  if (b1 == droid || b2 == droid) { // b1 or b2 are the droid
    ...
    //println("droid");
    droidSound.cue(0);
    droidSound.speed(impulse / 100);
    droidSound.play();
  }
  for (int i=0;i<crates.length;i++) {
    if (b1 == crates[i] || b2 == crates[i]) {// its a crate
      crateSounds[i].cue(0);
      crateSounds[i].speed(0.125 + (impulse / 250));// 10000 as the crates move slower??
      crateSounds[i].play();
    }
  }
  //
